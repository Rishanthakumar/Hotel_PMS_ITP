    ...
    <div class="row" style="margin-top: 0%">
        ...
        <div class="col-md-12">
            ...
            <ul class="nav nav-tabs">
                ...
                <li>
                    <a href="/payments">FIT Folio</a>
                </li>

                <li>
                    <a href="/TApayments">Travel Agent's Folio</a>
                </li>

                <li>
                    <a href="/CmpPayments">Company Folio</a>
                </li>
                <li class="active">
                    <a href="/oldFolios">Checked Out Folio</a>
                </li>
                ...
                <table class="table table-hover table-condensed table-bordered" id="folioTable">
                    ...
                    @foreach($folios as $folio)
                        ...
                        <tr class="active">
                            ...
                            <td>
                                <a href="/oldFolio_detailed/{{ $folio->folio_num }}" class="btn btn-primary">View This Folio</a>
                                {{--<a href="/payments/defaultCharges/{{ $folio->folio_num }}" class="btn btn-primary"> Add Default Charges</a>--}}
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
