...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
		...
		<form method="POST"  class="form-horizontal" role="form" action={!! url('/reservations/waitlist') !!} ><input type="hidden" name="_token" value="{{ csrf_token() }}">
		...
		<div class="row" style="margin-bottom: 2%">
			...
			<div class="col-md-12">
				...
				<div class="btn-group col-sm-1">
					<a class="btn btn-warning  " style="width: 200%" href="{!! url('/FO_mainpage') !!}">Cancel
					</a>
				</div>
				...
				<div class="col-sm-1">
				<button type="submit" class="btn btn-primary" style="width: 200%">
					Confirm Waitlist
				</button>
				</div>
