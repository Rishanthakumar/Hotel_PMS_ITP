	  ...
	  <div class="row">
		  ...
		  <div class="col-md-12">
			  <ul class="nav nav-tabs">
				  <li>
					  <a href="{{ url('/temp_check_out') }}">Check-Out</a>
				  </li>
				  <li class="active">
					  <a href="#">Check-In</a>
				  </li>
			...
			<table id="table_id" class="display table-bordered">
				...
				<tr>
					...
					?>
						...
						<td>
							{{ strtok($reservdetail->temp_check_in," ") }}
						</td>
						<td>
							{{ strtok($reservdetail->temp_check_out," ") }}
						</td>
						<td>
						...
						<td>
							...
							{!! Form::open(['method'=>'post','action' => 'ReservationController@temp_check_in']) !!}
							<input type="hidden" name="_token" value="{{ csrf_token() }}">
							<input type ="hidden" name="res_id" id="res_id" value="{{ $reservdetail->res_id }}">

								<button type="submit" class="btn btn-primary btn-sm" style="margin-left: 5%" >Check-In</button>
