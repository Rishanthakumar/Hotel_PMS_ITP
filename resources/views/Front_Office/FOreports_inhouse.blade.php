	...
	<div class="row" style="margin-top: 2%">
			...
			<div class="col-md-12" >
				...
				<table class="table table-hover table-bordered" id="table_id">
					...
					<tr>
						...
						<td>
							{!!  $array2[$reserve->res_id]['room_ids']!!}
						</td>
		...
		<div class="row">
			<div class="col-md-12" align="center">
				<a class="btn btn-primary" href="{!! url('/pdf_generate_inh') !!} " @if($reser == null && $array2 == null) disabled @endif>Generate Report</a>
			</div>
		</div>
</div>
