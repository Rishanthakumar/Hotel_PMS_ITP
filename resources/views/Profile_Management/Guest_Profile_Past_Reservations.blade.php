    ...
    <div class="container">
		<div class="row" >
			...
			<div class="row">
				<div class="col-md-12">
					<ul class="nav nav-tabs">
						...
						<li>
							<a href="{{ url('/guest_profile/futurereservations') }}">Future Reseravations</a>
						</li>
			...
			<div class="row" style="margin-top: 3%">
				<div class="col-md-12">
					<table id="past_res" class="table table-bordered table-condensed">
						<thead>
						<tr class="success">
							<th>
								Customer ID
										...
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													...
													<h4 class="modal-title text-center">Past Reservation Details - Customer : {{$reserva -> cus_id}} </h4>
												</div>
