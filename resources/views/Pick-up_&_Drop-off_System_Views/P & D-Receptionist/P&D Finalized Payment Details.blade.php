...
<html lang="en">
  ...
  <div class="col-md-12">
	  ...
	  <div class="row" style="margin-top: 5%">
		  ...
		  <div class="col-md-12">
			  ...
			  <ul class="nav nav-tabs">
				  <li role="presentation"><a href="/pendingpaymenthandling"style="color:grey">Pending Payment Details</a></li>
				  <li role="presentation" ><a href="/creditpaymenthandling"style="color:grey" >Credit Payment Details</a></li>
				  <li role="presentation"class="active"><a href="/finalizedpaymenthandling">Finalized Payment Details</a></li>
	  ...
	  @endif
		...
		<div class="col-md-12">
			...
			<table id="FinalizedPaymentTable" class="table table-bordered table-condensed table-hover ">
				<thead>
				<tr class="success">
					<th>
						Payment ID
  ...
  <script type="text/javascript">
	  $(document).ready(function(){
		  $('#FinalizedPaymentTable').DataTable();
	  });
  </script>
