...
<body style="font-family: sans-serif">
    ...
    <h4 style="font-family: sans-serif; text-align: center">Pick-up & Drop-off Invoice</h4>
    ...
    <div style="width: 100%; position: absolute; top: 55%">
        ...
        <table width="100%" id="id">
            <tr>
                <td rowspan="2">
                    <b>Remarks</b>
                    <p>Thank you for reserving a vehicle. Enjoy your stay at Randholi.</p>
                    <br>
                    <br>
                    <br>
                </td>
