  ...
  <div class="col-md-12">
	  ...
	  <div class="row" style="margin-top: 5%">
		  ...
		  <div class="col-md-12">
			  ...
			  <ul class="nav nav-tabs">
				  ...
				  <li role="presentation" class="active"><a href="/creditpaymenthandling" >Credit Payment Details</a></li>
	  ...
	  @endif
		...
		<div class="col-md-12">
			...
			<table id="CreditPaymentTable" class="table table-bordered table-condensed table-hover ">
				<thead>
				<tr class="success">
					<th>
						Payment ID
