...
--}}
	...
	@endif
		...
		<div class="col-md-12">
			...
			<table id="RemoveDriverDetailsTable" class="table table-bordered table-condensed table-hover"style="margin-top: 3%">
				<thead>
				<tr class="success">
					<th>
						Driver ID
				...
				@foreach ($drivers as $driver)
					...
					<tr class="active">
						...
						<td class="col-sm-1">
							<a class="btn btn-warning btn-sm" style="margin-left: 30%" data-toggle="modal" data-target="#{{$driver -> driver_id}}" href="#"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> </a>
									...
									<div class="modal-dialog">
										...
										<div class="modal-content">
											<div class="modal-header">
												...
												<h4 style="text-align: center">Remove Driver : {{ $driver->driver_id }}</h4>
											</div>
											<div class="modal-body">
												<form method="post" class="form-horizontal" role="form" style="margin-top: 5%" action={!! url('removedriver') !!}>
													<input type="hidden" name="_token" value="{{ csrf_token() }}"><input type="hidden" name="driver_id" value="{{ $driver -> driver_id}}">
														...
														<div class="col-md-12">
															...
															<div class="form-group">
																...
																<div id="deleteWarning" class="alert alert-danger">
																	<strong style="margin-left: 25%">Warning : </strong>You are about to delete a driver!
																	</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#RemoveDriverDetailsTable').DataTable();
	});
</script>
