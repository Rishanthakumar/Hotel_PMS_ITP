	...
	<div class="row">
		<div class="col-md-11">
			<h4 class="text-muted" style="margin-top: 2%;margin-left: 1%">
				Update Vehicle Travelling Packages
			</h4>
		</div>
  ...
  <div class="col-md-12">
	  ...
	  <table id="UpdateVehicleLegalTable" class="table table-bordered table-condensed table-hover" style="margin-top: -30%">
		  ...
		  @foreach ($vehicle_packages as $vehicle_packages)
			  <tr class="active">
				  <td>
					  {{$vehicle_packages -> package_id}}
				  </td>
				  <td>
					  {{$vehicle_packages -> package_name}}
				  </td>
				  <td>
					  {{$vehicle_packages -> package_price}}
				  </td>

				  <td >
					  <a class="btn btn-primary btn-sm" style="margin-left: 15%" data-toggle="modal" data-target="#e{{$vehicle_packages -> package_id}}" href="#"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> </a>
					  <a class="btn btn-warning btn-sm"  data-toggle="modal" data-target="#d{{$vehicle_packages -> package_id}}" href="#"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> </a>

					  <!-- Trigger the modal with a button -->


					  <!-- Modal -->
					  <div id="e{{$vehicle_packages -> package_id}}" class="modal fade" role="dialog">
						  <div class="modal-dialog">
							  ...
							  <div class="modal-content">
								  <div class="modal-header">
									  ...
									  <h4  style="text-align: center">Vehicle Travelling Package : {{ $vehicle_packages -> package_name }}</h4>
								  </div>
								  <div class="modal-body">
									  <form method="post" class="form-horizontal" role="form" style="margin-top: 5%" action="updatepackage">
										  ...
										  <div class="form-group">
											  ...
											  <div class="col-sm-6">
												  <input class="form-control" id="package_id" name="package_id" readonly value="{{$vehicle_packages -> package_id}}" type="text">
											  </div>
										  </div>
										  ...
										  <div class="form-group">
											  ...
											  <div class="col-sm-6">
												  <input class="form-control" id="package_name" name="package_name" value="{{$vehicle_packages -> package_name}}" type="text">
											  </div>
										  </div>
										 ...
										 <div class="form-group">
											  ...
											  <div class="col-sm-6">
												  <input class="form-control" id="package_price" name="package_price" value="{{$vehicle_packages -> package_price}}" type="text">
					  ...
					  <div id="d{{$vehicle_packages -> package_id}}" class="modal fade" role="dialog">
						  <div class="modal-dialog">
							  ...
							  <div class="modal-content">
								  <div class="modal-header">
									  <button type="button" class="close" data-dismiss="modal">&times;</button>
									  <h4 class="modal-header" style="text-align: center">Remove Vehicle Travelling Package : {{ $vehicle_packages -> package_id }}</h4>
								  </div>
								  <div class="modal-body">
									  <form method="post" class="form-horizontal" role="form" style="margin-top: 5%" action={!! url('removepackage') !!}>
										  <input type="hidden" name="_token" value="{{ csrf_token() }}">
										  <input type="hidden" name="package_id" value="{{ $vehicle_packages -> package_id}}">
										  <div class="form-group">
											  ...
											  <div class="col-md-12">
												  ...
												  <div class="form-group">
													  ...
													  <div id="deleteWarning" class="alert alert-danger">
														  <strong style="margin-left: 15%">Warning : </strong>You are about to delete a Vehicle Travelling Package!
													  </div>
