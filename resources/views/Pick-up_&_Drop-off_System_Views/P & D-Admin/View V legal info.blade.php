...
<div class="container">
  ...
  <!--<li class="dropdown pull-right">
	...
	<div class="row">
		<div class="col-md-11">
			<h4 class="text-muted" style="margin-top: 2%;margin-left: 1%">
				View Vehicle Legal Information
			</h4>
		</div>
	...
	<div class="row">	<div class="row">
			...
			<div class="col-md-13" style="margin-top: -2%">
				<table id="ViewVehicleLegalTable" class="table table-bordered table-condensed table-hover">
					<thead>
					<tr class="success">
						<th>
							VLI ID
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#ViewVehicleLegalTable').DataTable();
	});
</script>
